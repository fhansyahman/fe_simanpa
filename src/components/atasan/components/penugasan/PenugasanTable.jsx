      ...
      <table className="w-full">
        <thead className="bg-gray-50 border-b border-gray-200">
          <tr>
            ...
            <th className="py-4 px-6 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Batas Akhir Pulang</th>
          ...
          {filteredPenugasan.map((penugasan) => (
            <tr key={penugasan.id} className="hover:bg-gray-50 transition-colors">
              ...
              <td className="py-4 px-6">
                ...
                {penugasan.batas_akhir_pulang && (
                  <span className="text-xs text-red-400 ml-1">(no tolerance)</span>
                )}
              </td>
