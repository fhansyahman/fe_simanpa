...
import { Menu, LogOut, MapPin, AlertCircle, Clock, TrendingUp, BarChart3 } from 'lucide-react';
    ...
    <header className="sticky top-0 z-20 bg-gray-900 border-b border-gray-800 shadow-lg">
      <div className="h-16 px-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-white">Dashboard Pemantauan</h2>
          </div>
        </div>
